...
export default function Create({ drivers, trucks, villes }) {
    console.log('Received props:', { drivers, trucks, villes }); // Debug log

    const { data, setData, post, processing, errors } = useForm({
        driver_id: '',
        truck_id: '',
        ville_id: '', // Changed from ville to ville_id
                        ...
                        <div className="p-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    >
                                        <label htmlFor="ville_id" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                            City
                                        </label>
                                        <select
                                            id="ville_id"
                                        ...
                                        {errors.ville_id && (
                                            <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.ville_id}</p>
                                        )}
                                    </motion.div>
                                    {/* Date Input */}
                                    <motion.div
